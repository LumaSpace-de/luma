  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className={cn(
          "flex-1 bg-transparent outline-none placeholder:text-muted-foreground/30 disabled:cursor-default",
          sizeClass
        )}
      />
    </div>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragOver && "border-t-2 border-primary pt-2"
      )}
    >
      {canEdit && (
        <div className="absolute -left-7 top-0 flex h-full flex-col items-center justify-start pt-1 opacity-0 transition-opacity group-hover:opacity-100">
          <button
            className="cursor-grab rounded p-0.5 text-muted-foreground/40 hover:bg-accent hover:text-muted-foreground active:cursor-grabbing"
            title="Verschieben"
          >
          ...
          <button
            onClick={onDelete}
            className="rounded p-0.5 text-muted-foreground/40 hover:bg-accent hover:text-destructive"
            title="Block löschen"
          >
